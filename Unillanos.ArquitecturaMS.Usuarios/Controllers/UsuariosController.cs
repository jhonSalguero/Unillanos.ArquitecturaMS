...
namespace Unillanos.ArquitecturaMS.Usuarios.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public string Get()
        {
            string path = @"C:\Windows\Temp\dbUsers.json";
        ...
        [HttpPut]
        [Route("UpdateUsuario/{nombre}/{apellido}/{sexo}/{correo}/{edad}")]
        public string Put(UsuariosDto user,String nombre, String apellido, String sexo, String correo, String edad)
        {
            string path = @"C:\Windows\Temp\dbUsers.json";
